...
export function scrollTriggerConfig(overrides: ScrollTrigger.Vars = {}): ScrollTrigger.Vars {
  return {
...
export function enableLenisScroll(lenis: LenisLike) {
  ...
  ScrollTrigger.defaults({ scroller: document.documentElement, invalidateOnRefresh: true });
...
export function disableLenisScroll() {
  ...
  ScrollTrigger.defaults({ scroller: undefined, invalidateOnRefresh: true });
}
