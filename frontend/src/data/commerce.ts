...
export const commerceCategories: CommerceCategory[] = [
  ...
  },
  {
    slug: "accessory",
    label: "اکسسوری",
    eyebrow: "Accessories / 08",
    description: "آخرین لایه برای کامل‌کردن ترکیب خانه.",
    story: "انتخاب‌های کوچک و قابل جابه‌جایی که با فصل، حال‌وهوا و سبک زندگی شما تغییر می‌کنند.",
    image: "https://choobohonar.com/wp-content/uploads/2026/07/آباژور-آراگونیت-1.jpg",
    taxonomySlug: "accessory",
    children: [],
  },
];
