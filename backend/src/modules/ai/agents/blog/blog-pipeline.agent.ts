...
export class BlogPipelineAgent {
  ...
  async run(
    ...
    onProgress(
      'تحلیل موضوع',
      isFa
        ? 'در حال تحلیل موضوع و کلیدواژه‌ها...'
    ...
    onProgress(
      'ساختار محتوا',
      isFa ? 'در حال تنظیم ساختار مقاله...' : 'Structuring article outline...',
      30,
    );
    ...
    onProgress(
      'نگارش محتوا',
      isFa ? 'در حال نوشتن متن مقاله...' : 'Writing article content...',
      50,
    );
    ...
    onProgress(
      'بهینه‌سازی SEO',
      isFa
        ? 'در حال بهینه‌سازی برای موتورهای جستجو...'
    ...
    try {
      ...
      return {
        ...
        body: raw,
        keywords: job.input.targetKeywords || [],
      };
    }
  }
